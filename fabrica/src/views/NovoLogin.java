...
public class NovoLogin extends javax.swing.JFrame {
       ...
       LoginFuncionario novoFuncionario = new LoginFuncionario();
    ...
    private void cadNovoFuncionario(LoginFuncionario novoFuncionario){
    ...
    private void initComponents() {
        ...
        txt_senhadois = new javax.swing.JPasswordField();
        ...
        txt_senhadois.setBounds(80, 330, 350, 22);
        ...
        txt_senha.setBounds(80, 260, 350, 22);

        jLabel1.setFont(new java.awt.Font("Segoe UI Black", 0, 24)); // NOI18N
        jLabel1.setText("CADASTRAR");
        jPanel2.add(jLabel1);
        jLabel1.setBounds(180, 40, 160, 60);
    ...
    private void btn_criarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_criarActionPerformed
        ...
        if(!senha.equals("") && !senhadois.equals("") && !user.equals("")){
            Boolean senhasValida = senhasIguais(senha,senhadois);
                ...
                setLabel("Senhas incompativeis", Color.red);
            } 
        }else{
    ...
    private javax.swing.JPasswordField txt_senhadois;
